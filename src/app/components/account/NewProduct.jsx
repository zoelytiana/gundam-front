...
function NewProduct(props) {
    return (
        <div className="NewProducts">
            <h3 className="homeCardTitle"><span className="homeCardTitleSpan uppercase">Nouveaux produits</span></h3>
            <ul className="lg:flex">
                {props.gundams.map(gundam => {
                    return (
                        <li className="m-6" key={gundam.id}>
                            <div className="box-product-bottom w-60">
                                <div className="box-product h-60">
