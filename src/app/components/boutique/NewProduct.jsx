...
function NewProduct(props) {
    return (
        <div className='w-full h-full bg-gradient-to-b from-blue-900 via-red-500 to-blue-300 flex flex-col items-center p-8'>            
            <h3 className="uppercase text-white">Nouveau produits</h3>
