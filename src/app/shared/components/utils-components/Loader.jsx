        ...
        <div className="">
            ...
            bg-gray-800 opacity-50 flex flex-col items-center justify-center">
                ...
                <div className="bg-white flex space-x-2 p-3 rounded-full justify-center items-center">
                    <div className="bg-blue-600 point animate-bounce anim-delay-100">&nbsp;</div>
                    <div className="bg-green-600 point animate-bounce anim-delay-300">&nbsp;</div>
                    <div className="bg-red-600 point animate-bounce anim-delay-600">&nbsp;</div>
                </div>
